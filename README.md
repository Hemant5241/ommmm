<p align="center">
  <img src="https://raw.githubusercontent.com/jshor/OrreryWeb2/master/public/static/img/logo-gradient-dark.png" width="450" height="88" />
</p>

<br>

<p align="center">
  <a href="https://codecov.io/gh/jshor/OrreryWeb"><img
    src="https://img.shields.io/codecov/c/github/jshor/OrreryWeb.svg?style=for-the-badge"
    alt="Code coverage"
  /></a> <a href="https://github.com/jshor/OrreryWeb/actions?query=workflow%3A%22Build+and+deploy%22"><img
    src="https://img.shields.io/github/workflow/status/jshor/OrreryWeb/Build%20and%20deploy?style=for-the-badge"
    alt="Build status"
...
This is a real-time, WebGL-based, 3D visualization of our Solar System. It's a complete re-write of the [original OrreryWeb.io](https://github.com/jshor/OrreryWeb.io) project. Check out the full experience at **[OrreryWeb.io](https://OrreryWeb.io)**!
...
The JSON data for `orbitals.json` is generated by the [yarn orbitals](#yarn-orbitals) script. It will look for all of the JSON files in the `public/static/data/orbitals` directory. For information on the file structure for these JSON files, please see the [Wiki](https://github.com/jshor/OrreryWeb2/wiki/Orbital-JSONs).
...
Takes all orbital JSONs, probes the [NASA/JPL HORIZONS database]() for ephemeris data, and updates each JSON accordingly. For more information on this script, and on the prerequisite data format, please see [this wiki page](https://github.com/jshor/OrreryWeb2/wiki/Orbital-JSONs#nasa-jpl-horizons).
...
* Project developed by [Lakshya](http://josh.so)
